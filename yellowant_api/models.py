...
class azure(models.Model):
    """
    Model to store Azure credentials.
    """
    ...
    AZURE_client_secret = models.CharField(max_length=200)
    AZURE_update_login_flag = models.BooleanField(max_length=2, default=False)
